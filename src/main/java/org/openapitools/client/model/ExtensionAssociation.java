...
public class ExtensionAssociation {
  ...
  public ExtensionAssociation id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ExtensionAssociation extensionArn(@javax.annotation.Nullable String extensionArn) {
  ...
  public ExtensionAssociation resourceArn(@javax.annotation.Nullable String resourceArn) {
  ...
  public ExtensionAssociation arn(@javax.annotation.Nullable String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public ExtensionAssociation parameters(@javax.annotation.Nullable Map parameters) {
  ...
  public ExtensionAssociation extensionVersionNumber(@javax.annotation.Nullable Integer extensionVersionNumber) {
  ...
  public boolean equals(Object o) {
    ...
    ExtensionAssociation extensionAssociation = (ExtensionAssociation) o;
    return Objects.equals(this.id, extensionAssociation.id) &&
        Objects.equals(this.extensionArn, extensionAssociation.extensionArn) &&
        Objects.equals(this.resourceArn, extensionAssociation.resourceArn) &&
        Objects.equals(this.arn, extensionAssociation.arn) &&
        Objects.equals(this.parameters, extensionAssociation.parameters) &&
        Objects.equals(this.extensionVersionNumber, extensionAssociation.extensionVersionNumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, extensionArn, resourceArn, arn, parameters, extensionVersionNumber);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExtensionAssociation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExtensionAssociation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExtensionAssociation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExtensionAssociation is not found in the empty JSON string", ExtensionAssociation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExtensionAssociation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExtensionAssociation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("ExtensionVersionNumber") != null && !jsonObj.get("ExtensionVersionNumber").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("ExtensionVersionNumber"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExtensionAssociation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExtensionAssociation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExtensionAssociation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExtensionAssociation.class));

       return (TypeAdapter<T>) new TypeAdapter<ExtensionAssociation>() {
           @Override
           public void write(JsonWriter out, ExtensionAssociation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExtensionAssociation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExtensionAssociation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExtensionAssociation
   * @throws IOException if the JSON string is invalid with respect to ExtensionAssociation
   */
  public static ExtensionAssociation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExtensionAssociation.class);
  }

  /**
   * Convert an instance of ExtensionAssociation to an JSON string
   *
   * @return JSON string
   */
