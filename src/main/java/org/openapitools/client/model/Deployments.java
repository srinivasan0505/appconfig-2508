...
public class Deployments {
  ...
  public Deployments items(@javax.annotation.Nullable List items) {
    this.items = items;
    return this;
  }
  ...
  public Deployments nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, deployments.items) &&
        Objects.equals(this.nextToken, deployments.nextToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Deployments
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Deployments.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Deployments is not found in the empty JSON string", Deployments.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Deployments.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Deployments` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Deployments.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Deployments' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Deployments> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Deployments.class));

       return (TypeAdapter<T>) new TypeAdapter<Deployments>() {
           @Override
           public void write(JsonWriter out, Deployments value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Deployments read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Deployments given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Deployments
   * @throws IOException if the JSON string is invalid with respect to Deployments
   */
  public static Deployments fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Deployments.class);
  }

  /**
   * Convert an instance of Deployments to an JSON string
   *
   * @return JSON string
   */
