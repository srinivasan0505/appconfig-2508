...
public class DeploymentStrategies {
  ...
  public DeploymentStrategies items(@javax.annotation.Nullable List items) {
    this.items = items;
    return this;
  }
  ...
  public DeploymentStrategies nextToken(@javax.annotation.Nullable String nextToken) {
