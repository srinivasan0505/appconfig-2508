...
public class ConfigurationProfiles {
  ...
  public ConfigurationProfiles items(@javax.annotation.Nullable List items) {
    this.items = items;
    return this;
  }
  ...
  public ConfigurationProfiles nextToken(@javax.annotation.Nullable String nextToken) {
