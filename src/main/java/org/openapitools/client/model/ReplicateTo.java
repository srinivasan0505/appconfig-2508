...
/**
 * Gets or Sets ReplicateTo
 */
@JsonAdapter(ReplicateTo.Adapter.class)
public enum ReplicateTo {
  ...
  public static ReplicateTo fromValue(String value) {
    for (ReplicateTo b : ReplicateTo.values()) {
  ...
  public static class Adapter extends TypeAdapter<ReplicateTo> {
    @Override
    public void write(final JsonWriter jsonWriter, final ReplicateTo enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ReplicateTo read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ReplicateTo.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ReplicateTo.fromValue(value);
  }
}
