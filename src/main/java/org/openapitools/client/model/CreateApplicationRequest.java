...
public class CreateApplicationRequest {
  ...
  public CreateApplicationRequest description(@javax.annotation.Nullable String description) {
  ...
  public CreateApplicationRequest tags(@javax.annotation.Nullable Map<String, String> tags) {
    this.tags = tags;
    return this;
  }
