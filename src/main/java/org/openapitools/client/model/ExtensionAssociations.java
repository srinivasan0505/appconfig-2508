...
public class ExtensionAssociations {
  ...
  public ExtensionAssociations items(@javax.annotation.Nullable List items) {
    this.items = items;
    return this;
  }
  ...
  public ExtensionAssociations nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ExtensionAssociations extensionAssociations = (ExtensionAssociations) o;
    return Objects.equals(this.items, extensionAssociations.items) &&
        Objects.equals(this.nextToken, extensionAssociations.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExtensionAssociations {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExtensionAssociations
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExtensionAssociations.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExtensionAssociations is not found in the empty JSON string", ExtensionAssociations.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExtensionAssociations.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExtensionAssociations` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExtensionAssociations.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExtensionAssociations' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExtensionAssociations> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExtensionAssociations.class));

       return (TypeAdapter<T>) new TypeAdapter<ExtensionAssociations>() {
           @Override
           public void write(JsonWriter out, ExtensionAssociations value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExtensionAssociations read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExtensionAssociations given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExtensionAssociations
   * @throws IOException if the JSON string is invalid with respect to ExtensionAssociations
   */
  public static ExtensionAssociations fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExtensionAssociations.class);
  }

  /**
   * Convert an instance of ExtensionAssociations to an JSON string
   *
   * @return JSON string
   */
