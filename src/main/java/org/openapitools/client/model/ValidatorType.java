 ...
 */
@JsonAdapter(ValidatorType.Adapter.class)
public enum ValidatorType {
  ...
  public static ValidatorType fromValue(String value) {
    for (ValidatorType b : ValidatorType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ValidatorType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ValidatorType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ValidatorType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ValidatorType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ValidatorType.fromValue(value);
  }
}
