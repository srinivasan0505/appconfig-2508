...
public class ApiClient {
    ...
    private String basePath = "http://appconfig.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://appconfig.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://appconfig.{region}.amazonaws.com",
      "The AppConfig multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://appconfig.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://appconfig.{region}.amazonaws.com.cn",
      "The AppConfig endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2019-10-09/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://appconfig.us-east-1.amazonaws.com
