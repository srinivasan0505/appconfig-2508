...
func DeletedeploymentstrategyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/deployementstrategies/%s", cfg.BaseURL, DeploymentStrategyId)
...
func CreateDeletedeploymentstrategyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_deployementstrategies_DeploymentStrategyId",
		mcp.WithDescription("Deletes a deployment strategy. Deleting a deployment strategy does not delete a configuration from a host."),
		...
		mcp.WithString("DeploymentStrategyId", mcp.Required(), mcp.Description("The ID of the deployment strategy you want to delete.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DeletedeploymentstrategyHandler(cfg),
	}
}
