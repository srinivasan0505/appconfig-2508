...
func ListdeploymentstrategiesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/deploymentstrategies%s", cfg.BaseURL, queryString)
		...
		var result models.DeploymentStrategies
...
func CreateListdeploymentstrategiesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_deploymentstrategies",
		mcp.WithDescription("Lists deployment strategies."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListdeploymentstrategiesHandler(cfg),
	}
}
