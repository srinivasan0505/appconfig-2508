...
func GetextensionassociationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetextensionassociationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_extensionassociations_ExtensionAssociationId",
		mcp.WithDescription("Returns information about an AppConfig extension association. For more information about extensions and associations, see <a href="https://docs.aws.amazon.com/appconfig/latest/userguide/working-with-appconfig-extensions.html">Working with AppConfig extensions</a> in the <i>AppConfig User Guide</i>."),
		...
		mcp.WithString("ExtensionAssociationId", mcp.Required(), mcp.Description("The extension association ID to get.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    GetextensionassociationHandler(cfg),
	}
}
