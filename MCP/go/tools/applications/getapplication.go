...
func GetapplicationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetapplicationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_applications_ApplicationId",
		mcp.WithDescription("Retrieves information about an application."),
		...
		mcp.WithString("ApplicationId", mcp.Required(), mcp.Description("The ID of the application you want to get.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    GetapplicationHandler(cfg),
	}
}
