...
func UpdateapplicationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateApplicationrequest
		...
		url := fmt.Sprintf("%s/applications/%s", cfg.BaseURL, ApplicationId)
...
func CreateUpdateapplicationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_applications_ApplicationId",
		mcp.WithDescription("Updates an application."),
		...
		mcp.WithString("Name", mcp.Description("Input parameter: The name of the application.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    UpdateapplicationHandler(cfg),
	}
}
