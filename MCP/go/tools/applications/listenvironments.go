...
func ListenvironmentsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/applications/%s/environments%s", cfg.BaseURL, ApplicationId, queryString)
...
func CreateListenvironmentsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_applications_ApplicationId_environments",
		mcp.WithDescription("Lists the environments for an application."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListenvironmentsHandler(cfg),
	}
}
