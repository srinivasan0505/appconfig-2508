...
func GetconfigurationprofileHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetconfigurationprofileTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_applications_ApplicationId_configurationprofiles_ConfigurationProfileId",
		mcp.WithDescription("Retrieves information about a configuration profile."),
		...
		mcp.WithString("ApplicationId", mcp.Required(), mcp.Description("The ID of the application that includes the configuration profile you want to get.")),
		mcp.WithString("ConfigurationProfileId", mcp.Required(), mcp.Description("The ID of the configuration profile that you want to get.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    GetconfigurationprofileHandler(cfg),
	}
}
