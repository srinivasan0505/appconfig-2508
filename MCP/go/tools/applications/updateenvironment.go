...
func UpdateenvironmentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateEnvironmentrequest
...
func CreateUpdateenvironmentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_applications_ApplicationId_environments_EnvironmentId",
		mcp.WithDescription("Updates an environment."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdateenvironmentHandler(cfg),
	}
}
