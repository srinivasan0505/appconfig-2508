...
func DeleteconfigurationprofileHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteconfigurationprofileTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_applications_ApplicationId_configurationprofiles_ConfigurationProfileId",
		mcp.WithDescription("Deletes a configuration profile. Deleting a configuration profile does not delete a configuration from a host."),
		...
		mcp.WithString("ApplicationId", mcp.Required(), mcp.Description("The application ID that includes the configuration profile you want to delete.")),
		mcp.WithString("ConfigurationProfileId", mcp.Required(), mcp.Description("The ID of the configuration profile you want to delete.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DeleteconfigurationprofileHandler(cfg),
	}
}
