...
class Get_ExtensionsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_ExtensionsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("max_results")) {
            queryParams.add("max_results=" + args.get("max_results"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_extensions" + queryString;
    ...
    public static MCPServer.Tool createGet_ExtensionsTool(MCPServer.APIConfig config) {
        ...
        nameProperty.put("description", "The extension name.");
        ...
        return new MCPServer.Tool(definition, getGet_ExtensionsHandler(config));
    }
