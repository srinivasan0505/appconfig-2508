/**
 * MCP Server function for Lists the configuration profiles for an application.
 */
...
class Get_Applications_Application_Id_ConfigurationprofilesMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Applications_Application_Id_ConfigurationprofilesHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("max_results")) {
            queryParams.add("max_results=" + args.get("max_results"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_applications_application_id_configurationprofiles" + queryString;
    ...
    public static MCPServer.Tool createGet_Applications_Application_Id_ConfigurationprofilesTool(MCPServer.APIConfig config) {
        ...
        typeProperty.put("description", "A filter based on the type of configurations that the configuration profile contains. A configuration can be a feature flag or a freeform configuration.");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_applications_application_id_configurationprofiles",
            "Lists the configuration profiles for an application.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Applications_Application_Id_ConfigurationprofilesHandler(config));
    }
