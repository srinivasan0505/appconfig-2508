/**
 * MCP Server function for Lists the environments for an application.
 */
...
class Get_Applications_Application_Id_EnvironmentsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Applications_Application_Id_EnvironmentsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("max_results")) {
            queryParams.add("max_results=" + args.get("max_results"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_applications_application_id_environments" + queryString;
    ...
    public static MCPServer.Tool createGet_Applications_Application_Id_EnvironmentsTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_applications_application_id_environments",
            "Lists the environments for an application.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Applications_Application_Id_EnvironmentsHandler(config));
    }
