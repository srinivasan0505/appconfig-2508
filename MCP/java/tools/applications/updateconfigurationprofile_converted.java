/**
 * MCP Server function for Updates a configuration profile.
 */
...
class Patch_Applications_Application_Id_Configurationprofiles_Configuration_Profile_IdMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPatch_Applications_Application_Id_Configurationprofiles_Configuration_Profile_IdHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("Validators")) {
            queryParams.add("Validators=" + args.get("Validators"));
                ...
                String url = config.getBaseUrl() + "/api/v2/patch_applications_application_id_configurationprofiles_configuration_profile_id" + queryString;
    ...
    public static MCPServer.Tool createPatch_Applications_Application_Id_Configurationprofiles_Configuration_Profile_IdTool(MCPServer.APIConfig config) {
        ...
        ConfigurationProfileIdProperty.put("description", "The ID of the configuration profile.");
        ...
        NameProperty.put("description", "Input parameter: The name of the configuration profile.");
        ...
        RetrievalRoleArnProperty.put("description", "Input parameter: The ARN of an IAM role with permission to access the configuration at the specified <code>LocationUri</code>.");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "patch_applications_application_id_configurationprofiles_configuration_profile_id",
            "Updates a configuration profile.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPatch_Applications_Application_Id_Configurationprofiles_Configuration_Profile_IdHandler(config));
    }
